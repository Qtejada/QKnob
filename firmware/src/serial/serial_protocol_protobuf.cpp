//Used for primarily recieving data from the host (config of system)
...
/// @brief Initializes protobuf protocol
/// @param stream UART stream command
/// @param config_callback recieve a call back?
...
void SerialProtocolProtobuf::loop() {
   ...
   //Update data while UART is availble
    do {
...
/// @brief Recieve data from the host
/// @param buffer 
/// @param size 
